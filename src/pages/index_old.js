...
const corruptionStats = [
  {
    ...
    description: "Dunyo iqtisodiyotiga yetkazadigan korrupsiyaning zarari",
  },
  {
    icon: Shield,
    stat: "100%",
...
const presidentInsights = [
  {
    quote:
      "Korrupsiya bilan hech qachon maqsadimizga erisha olmayiz. Korrupsiyaga qarshi kurashishda aholining barcha qatlamlari, eng yaxshi mutaxassislar jalb qilinmas ekan, jamiyatimizning barcha a'zolari, ta'bir joiz bo'lsa 'halollik vaksinasi' bilan emlanmas ekan, o'z oldimizga qo'ygan yuqsak maqsadlariga erisha olmayiz. Biz korrupsiyaning oqibatlari bilan kurashishdan uning barvoqt oldini olishga o'tishimiz kerak.",
  ...
  {
    quote:
      "Barchamizga ma’lumki, korrupsiya hozirgi zamon milliy va xalqaro huquqida keng tarqalgan salbiy illatdir. Biz korrupsiyaga qarshi kurashish va unga barvaqt chek qo‘yish uchun ichki nazoratlarni, halollik standartlarini va monitoring tizimlarini kuchaytirdik. Har bir rahbar va xodimdan komplayens siyosatiga qat’iy rioya qilishni, korrupsiyaga yo‘l qo‘ymaslikni va xizmat vazifalarini halol bajarishni so‘rayman. Agarda korrupsion holat yoki manfaatlar to‘qnashuvi yuzaga kelsa, iltimos, +99855 5101509 yoki +99899 1109950 raqamlariga murojaat qiling.",
    source: '"Issiqlik elektr stantsiyalari" AJ Boshqaruvi raisi — B.I.Jurayev',
    emphasis: "Halollik, Komplayens va Javobgarlik",
  ...
  },
  {
    ...
    source: "O'zbekiston Respublikasi I  slohotlar Dasturi",
...
const managerFeedbackSlides = [
  {
    slide: 1,
    title: "Boshqaruv Rahbarining Ohang-Sadoi",
    description:
      "Issiqlik Elektr Stantsiyalari AJ Boshqaruvi raisi B.I.Jurayev korrupsiyaga qarshi kurashish va komplayens bo'yicha muhim xabar bildirmoqda.",
    quote:
      "Barchamizga ma'lumki, hozirgi zamon milliy va xalqaro huquqida tobora ko'p qo'llanilayotgan salbiy illatlardan biri bu korrupsiyadir. Keyingi yillarda mamlakatimizda korrupsiyaning oldini olish va unga qarshi kurashish, davlat va jamiyat qurilishining barcha sohalarida korrupsiyogen omillarga chek qo'yishga qaratilgan keng ko'lamli islohotlar izchil amalga oshirilmoqda. Shuningdek, \"Issiqlik elektr stantsiyalari\" AJ tizimida korrupsiyaga qarshi ichki nazorat tuzilmalari tashkil etilganligi, ushbu yo'nalishda samarali tizim yaratilganligi, jamiyatning korrupsiyaga qarshi kurashish bo'yicha siyosati, korrupsiyaviy xavf-xatarlarni baholash uslubiyoti, manfaatlar to'qnashuvini boshqarish nizomi, aloqa kanallari orqali xabarlarni qabul qilish reglamenti, etika va korrupsiyaga qarshi kurashish sohasida o'qitilish yo'riqnomalari, kontragentlarni tekshirish va ishga qabul qilinayotgan nomzodlarni tekshirish yo'riqnomalari tegishli buyruqqa muvofiq tasdiqlangan. Ushbu siyosatning tamoyillari va talablari barcha hodimlar uchun, ularning egallab turgan lavozimidan qat'iy nazar, majburiy. Shuningdek, \"Issiqlik elektr stantsiyalari\" AJ tizimida mehnat qilayotgan har bir rahbar va xodimni korrupsiyaga qarshi siyosat talablariga qat'iy rioya qilishlariga, korrupsiya bilan bog'liq noqonuniy harakatlarga yo'l qo'ymaslikka, korrupsiya holatlarining har qanday ko'rinishlariga nisbatan murosasiz munosabatda bo'lishga hamda o'z xizmat vazifalarini halol va xolis bajarishga yana bir bor chaqiraman. Agarda sohada korrupsion holat yoki manfaatlar to'qnashuviga xos holatlarga duch kelsangiz, iltimos, \"Issiqlik elektr stantsiyalari\" AJning komplayens boshqarmasining +99855 5101509, +99899 1109950 ishonch raqamlariga murojaat qiling.",
    image: "/files/manager_image.jpg",
  },
];
...
const internalDocuments = {
  ...
  subtitle:
    "Ushbu siyosatning tamoyillari va talablari barcha hodimlar uchun, ularning egallab turgan lavozimidan qat'iy nazar, majburiy.",
  items: [
    ...
    "Korrupsiyaviy xavf-xatarlarni aniqlash va baholash Usuluiyoti",
    "Hodimlarning korrupsiyaviy hatti-harakatlari va odob-axloq qoidalarini buzish holatlari ustidan xizmat tekshiruvalari otkizish boyicha Reglament",
    "Aloqa kanallari orqali korrupsiyaviy xatti-harakatlari to'g'risida kelib tushgan habarlarni qabul qilish va ko'rib chiqish Reglamenti",
    "Xodimlarning etika va korrupsiyaga qarshi kurashish sohasida uqitishni tashkil qilish boyicha Yoriqnoma",
...
export default function Home() {
  ...
  const [currentDisplayMode, setCurrentDisplayMode] = useState(4); // 0=stats, 1=insights, 2=corruption, 3=president, 4=internal-docs, 5=law-definitions, 6=anti-corruption-day, 7=manager-feedback
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setCurrentDisplayMode((prev) => (prev + 1) % 8);
    ...
    >
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <div className="flex-1 flex items-center justify-center px-3 py-2 relative overflow-hidden">
          ...
          {currentDisplayMode === 7 && (
            <div className="w-full h-full flex items-center justify-center animate-carousel-in px-3">
              <div className="w-full max-w-5xl grid grid-cols-2 gap-4">
                <div className="flex items-center justify-center">
                  <div className="relative w-full h-64 rounded-2xl overflow-hidden bg-slate-800 shadow-2xl">
                    {managerFeedbackSlides[0].image && (
                      <Image
                        src={managerFeedbackSlides[0].image}
                        alt="Manager"
                        fill
                        className="object-cover"
                      />
                ...
                <div className="flex flex-col justify-center">
                  <h2 className="text-2xl md:text-3xl font-bold mb-2">
                    {managerFeedbackSlides[0].title}
                  </h2>
                  <p className="text-sm md:text-base text-white/80 leading-tight mb-3">
                    {managerFeedbackSlides[0].description}
                  </p>
                  <div className="glass-effect-dark rounded-2xl p-3 max-h-32 overflow-y-auto">
                    <blockquote className="relative">
                      <p className="text-xs md:text-sm leading-tight italic font-light text-blue-100">
                        &quot;{managerFeedbackSlides[0].quote}&quot;
                      </p>
                    </blockquote>
                  </div>
                </div>
